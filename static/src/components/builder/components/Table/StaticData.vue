...
<template>
  <div class="row">
    ...
    >
      <div slot="afterTable">
        <button class="btn btn-sm btn-default pull-right" @click="addRow">
          Add Row
        </button>
      </div>
      <template
        ...
        class="col-md-12"
      >
        <div v-if="c.component === 'plain-text'" :key="i" class="">
          <input
            id="table-name"
        ...
        <div v-else :key="i">Answer Column</div>
      </template>
      <template slot="hide-delete" slot-scope="props">
        <button
