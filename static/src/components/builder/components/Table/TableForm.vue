      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div v-if="columnWithComponent" class="form-group">
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <input
                  ...
                  type="radio"
                />
                <label class="col-lables right-padding-radio" for="dynamic"
                  >Get table data from source</label
                >
                <input
                  id="static"
                  v-model="form.data.isVariable"
                  ...
                  type="radio"
                />
                <label class="col-lables" for="static"
                  >Enter table data manually</label
                >
              </div>
            </div>
            <label
              ...
              >* Field Data Source Name</label
            >
            <label v-if="!form.data.isVariable" class="col-form-label-md"
